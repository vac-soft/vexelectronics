                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="subject" name="company"
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" value="Sumbit" type="submit">Send
                                            Message</button>
                                    </div>
                                </div>
                            </form>
